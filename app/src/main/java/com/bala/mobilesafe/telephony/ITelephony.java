 ...
 * Original file: E:\\data\\itheima\\mobileSafe\\16\\day16\\code&����\\code\\MobileSafe\\src\\com\\android\\internal\\telephony\\ITelephony.aidl
 */
package com.bala.mobilesafe.telephony;
/**
...
{
private static final String DESCRIPTOR = "ITelephony";
...
/**
     ...
     */
@Override public void call(String number) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public int enableApnType(String type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
/**
     ...
     */
@Override public int disableApnType(String type) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
